...
//Serilog
//​​Seria possível na implementação da classe de manipulação da exceção você receber uma dependência de ILogger e,
//    desde que o serviço que vai capturar os dados de logging de esteja previamente >